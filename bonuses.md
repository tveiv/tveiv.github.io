...
/* Minecraft-like gold highlights for bold and underlined elements */
.card-desc b, .card-desc strong {
    color: #ffd54f; /* Яркий желто-золотой цвет Minecraft */
    font-weight: bold;
}
.card-desc u {
    color: #ffd54f; /* Тот же красивый золотистый цвет */
...
.card-icon {
    ...
    height: 32px;
    object-fit: contain;
    image-rendering: pixelated; /* Сохраняет четкость пикселей из ресурспака */
}
